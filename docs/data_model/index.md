...
|**[socket](socket)**|`bind`<br />`listen`<br />`put`|`family`<br />`image_path`<br />`local_address`<br />`local_path`<br />`local_port`<br />`pid`<br />`protocol`<br />`remote_address`<br />`remote_port`<br />`success`|
